              ...
              >
                ...
                <div style={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap' }}>
                  <Category
                    ...
                    className="mt-5 mb-5"
                  />
                  <Status position='relative' className={Styles.spanStatus} text={(project?.lotes[project?.lotes.length - 1]?.status === null || project?.lotes[project?.lotes.length - 1]?.status === undefined) ? 'Ativo' : project?.lotes[project?.lotes.length - 1]?.status} />
                </div>
                <Button
                  id="introducao-cta"
                  text={t.invest}
